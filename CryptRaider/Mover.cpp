...
UMover::UMover()
	: ShouldMoveDown(false), ShouldMoveUp(false), MoveTime(4.f)
{
...
void UMover::SetShouldMoveDown(bool value)
{
	ShouldMoveDown = value;
}

void UMover::SetShouldMoveUp(bool value)
{
	ShouldMoveUp = value;
}

bool UMover::GetShouldMoveDown()
{
